...
这一版不能再把 693 条当作素材总量。693 只是卡片元数据样本，适合看文案、日期、落地页和部分上新节奏；真实素材库口径来自前面的滚动 ad id 采集和高清下载验证：

- 收集并查询 ad id：8862 个。
- 保存高清素材文件：11226 个，其中视频 4047 个、图片 7179 个。
- 精确去重后素材代表：6336 个。
- 去重分类里 Arrows / arrow maze 主玩法素材：3860 个。
- 高清校验：视频主要为 720x1280，图片主要为 1080x1920；最终查询失败 0 个。

下面的“页面矩阵、上新节奏、文案主题、落地页”等仍是卡片元数据样本分析，不代表全量素材池。全量素材规模、复用和创意形态应以素材库口径为准。
